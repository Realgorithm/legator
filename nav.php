<div class="lime-sidebar">
    <div class="lime-sidebar-inner slimscroll">
        <ul class="accordion-menu">
            ...
            <li>
                <a href="#"><i class="material-icons">update</i>Mining Reports<i class="material-icons has-sub-menu">keyboard_arrow_left</i></a>
                <ul class="sub-menu">
                    <li>
                        <a href="index2.php?page=history&option=deposit">Deposit History</a>
                    </li>
                    <li>
                        <a href="index2.php?page=history&option=earning">Earning History</a>
                    </li>

                    <li>
                        <a href="index2.php?page=history&option=withdraw">Withdrawal History</a>
                    </li>
                </ul>
            </li>
            <li>
