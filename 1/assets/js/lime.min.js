$(document).ready(function () {
  ...
  !(function () {
    1 === $(".material-design-hamburger__icon").length &&
      document
        ...
        .addEventListener("click", function () {
          ...
          document.body.classList.toggle("background--blur"),
            ...
            (e = this.childNodes[1].classList).contains(
              "material-design-hamburger__icon--to-arrow"
            )
              ? (e.remove("material-design-hamburger__icon--to-arrow"),
                e.add("material-design-hamburger__icon--from-arrow"))
              : (e.remove("material-design-hamburger__icon--from-arrow"),
          ...
          return (
            o.hasClass("open")
              ? ($(".open .sub-menu li").each(function (e) {
                ...
                o.removeClass("open"))
              : (n.length &&
                  ($(".accordion-menu > li.open > .sub-menu").slideUp(200),
                  n.removeClass("open")),
                e.slideDown(200),
                o.addClass("open"),
                $(".open .sub-menu li").each(function (e) {
    ...
    (function () {
      $(".slimscroll").slimScroll({ wheelStep: 5 }),
        $('[data-toggle="popover"]').popover(),
        $('[data-toggle="tooltip"]').tooltip();
      !(function () {
        if ($(".image-crop").length) {
          var e = $(".image-crop > img");
          e.cropper({ preview: ".img-preview" }),
